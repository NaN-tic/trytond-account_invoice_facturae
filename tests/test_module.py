...
class AccountInvoiceFacturaeTestCase(CompanyTestMixin, ModuleTestCase):
    ...
    def test_format_decimal(self):
        ...
        self.assertEqual(
            Invoice.format_decimal(Decimal('1')),
            '1.00')
        self.assertEqual(
            Invoice.format_decimal(Decimal('1.2')),
            '1.20')
        self.assertEqual(
            Invoice.format_decimal(Decimal('1.234')),
            '1.23')
        self.assertEqual(
            Invoice.format_decimal(Decimal('1.123456789')),
            '1.12')
        self.assertEqual(
            Invoice.format_decimal(Decimal('0.079000'), 8, trim=True),
            '0.079')
        self.assertEqual(
            Invoice.format_decimal(Decimal('0.790000'), 8, trim=True),
            '0.79')
        self.assertEqual(
            Invoice.format_decimal(Decimal('1.200000'), 8, trim=True),
            '1.20')
    ...
    @with_transaction()
    def test_invoice_generation_missing_facturae_address_types(self):
        'Test automatic generation is skipped without facturae address types'
